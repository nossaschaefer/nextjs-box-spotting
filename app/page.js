  ...
  return (
    <div className="p-4 px-10 pt-10 sm:px-32 md:px-56 lg:px-72">
      <h2 className="text-2xl text-center font-black lg:text-4xl">
        Welcome to Box Spotting
      </h2>

      <p className="text-sm text-center lg:text-base">
        Use this app to organize your storage boxes
      </p>
      <div className="leading-loose pt-8 lg:text-xl lg:leading-loose">
        <p>
          You can give each box a <span className="font-black">name</span> and
          fill it with <span className="font-black">items</span>. If you want
          you can also add a <span className="font-black">location</span> , a{" "}
        ...
        <p>
          If something changed, you can always{" "}
